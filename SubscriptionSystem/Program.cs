...
var dbConnectionString = builder.Configuration.GetConnectionString("IdanSurestSecurityConnectionForPrediction");
builder.Services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlServer(dbConnectionString, sql =>
    {
        // Enable transient fault handling for RDS connectivity blips
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowSpecificOrigins", policy =>
    {
            policy.WithOrigins("http://localhost:3000",
                               ...
                               "https://localhost:7221") // Allow only these origins
